/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Tx77c84ItdX
    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-orange-100">
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="bg-yellow-100">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs font-medium text-muted-foreground hover:underline" prefetch={false}>
                  Forgot password?
                </Link>
              </div>
          ...
          <CardFooter>
            <Button type="submit" className="w-full bg-lime-200 hover:bg-lime-400/90 text-gray-900">
              Sign in
            </Button>
          </CardFooter>
        </Card>
