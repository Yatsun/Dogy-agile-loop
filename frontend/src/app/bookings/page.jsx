/**
 * v0 by Vercel.
 * @see https://v0.dev/t/6m4QGvXPBn1
  ...
  return (
    <div className="flex- w-full px-4 md:px-6 py-8 bg-orange-100">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button className="shrink-0 bg-lime-200 hover:bg-lime-400/90 text-gray-900">Create New Booking</Button>
      </div>
      <div className=" max-w-4xl mx-auto bg-white dark:bg-gray-950 rounded-lg shadow-md overflow-hidden bg-yellow-200">
        <div className="px-6 py-4 border-b">
          <Input placeholder="Search bookings..." value={search} onChange={handleSearch} className="w-full" />
        </div>
        <Table>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>
            {filteredBookings.map((booking) => (
              <TableRow key={booking.id}>
                <TableCell><a href="cancelation">{booking.name}</a></TableCell>
                <TableCell>
                  <div
