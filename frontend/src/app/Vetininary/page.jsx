...
* @see https://v0.dev/t/0EouTRXL3nc
      ...
      <div className="px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Nearby Veterinary Hospitals</h2>
        ...
        <div className="mx-auto grid max-w-5xl gap-8 py-12 lg:grid-cols-1">
          <div className="border shadow-sm rounded-lg">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">Paws and Claws Animal Hospital</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">Furry Friends Veterinary Clinic</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">Whiskers and Tails Animal Hospital</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">Purrfect Pets Veterinary Care</TableCell>
